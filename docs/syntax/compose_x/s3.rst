...
This module allows you to create new S3 Buckets, Lookup existing ones, and link them to your services or other AWS Resources,
where supported.
...
.. tip::
    ...
    You can find the test files for S3 `here <https://github.com/compose-x/ecs_composex/tree/main/use-cases/s3>`__ to use
...
.. jsonschema:: ../../../ecs_composex/specs/x-s3.spec.json

Definition
------------

.. literalinclude:: ../../../ecs_composex/specs/x-s3.spec.json
    :language: json
